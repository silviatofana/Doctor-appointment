  ...
  path '/api/v1/users/{id}' do
    ...
    put('update user') do
      response(200, 'successful') do
        ...
        let(:id) do
          User.create(name: 'Alex Ouma', gender: 'F', email: Faker::Internet.email, password: '123456',
                      password_confirmation: '123456', role: 'admin').id
        end
    ...
    delete('delete user') do
      response(401, 'successful') do
        let(:id) do
          User.create(name: 'Felix Ouma', gender: 'M', email: 'lauren@gmail.com', password: '123456',
                      password_confirmation: '123456', role: 'admin').id
        end
        run_test!
      end
      ...
      response(200, 'successful') do
        ...
        response(200, 'successful') do
          unless User.find_by(email: 'herald@gmail.com')
            User.create(name: 'Felix Ouma', gender: 'M', email: 'herald@gmail.com', password: '123456',
                        password_confirmation: '123456', role: 'admin')
          end
